...
void TOperator_base::Make_Bv_Be_IH4() 
{
  ...
  // fBd.resize(2*fN_max,fMd); 
  // fBs.resize(2*fN_max,2*fN_max);
...
void TOperator_base::Make_Bv_Be_IH2() 
{
  ...
  Set_Be_Jd_Parallel(1,4); 
  Set_Be_Js_Xsymmetry(2,3); 
  Set_Be_Js_Xsymmetry(0,5); 
}
...
void TOperator_base::Make_B_IH2( int k1, int k2 ) 
{
  ...
  Set_Bd_Jd_Parallel(1,4); 
  Set_Bd_Js_Xsymmetry(2,3); 
  Set_Bd_Js_Xsymmetry(0,5); 
...
//// IH27 ////
void TOperator_base::Make_Bv_Be_IH27() 
{
  int m;
  ...
  Set_Be_Js_Xsymmetry(0,3); 
  Set_Be_Js_Ysymmetry(1,4); 
  Set_Be_S(2); 
}

void TOperator_base::Make_B_IH27( int k1, int k2 ) 
{
  fn[0] = k1; 
  fn[1] = k2; 
  fn[2] = fN-fNv-2*fn[0]-2*fn[1];
  fn[3] = k1; 
  fn[4] = k2; 
